/**
 * GitLab "active right now" slide — pipelines whose status indicates they're
 * still running. Auto-hides via shouldShow() when nothing's in flight.
 */
import {
...
export async function render(state) {
  ...
  const body = `
    ${header({ title: "GITLAB · IN FLIGHT", nowLabel, bold: state?.paused })}
...
export default { id: "gitlab-active", name: "GitLab Active Pipelines", render, shouldShow };
